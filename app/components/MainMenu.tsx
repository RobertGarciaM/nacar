...
export function MainMenu() {
    ...
    return (
        <>
            ...
            {/* MOBILE PANEL */}
            {open && (
                <div className="fixed inset-0 z-50 overflow-hidden bg-ritual-cream px-6 py-6 md:hidden">
                    {/* ATMOSPHERE */}
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center text-walnut transition-colors duration-300 hover:text-espresso"
                    ...
                    <nav className="relative z-10 mt-[23vh] flex flex-col gap-6 font-serif text-[2.45rem] font-light leading-none tracking-[-0.035em] text-espresso">
                        {links.map((link) => (
                            <a
                                key={link.href}
                                href={link.href}
                    ...
                    <p className="relative z-10 mt-7 text-[12px] tracking-[0.4em] uppercase text-smoked-bronze">
                        {t("hero.eyebrow")}
                    </p>
